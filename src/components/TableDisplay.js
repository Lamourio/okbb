...
export default class TableDisplay extends Component {
  ...
  render() {
    ...
    return (
      <div>
        <ReactTable defaultPageSize={10} data={updatedData} columns={columns} />
        <TableFilter rows={updatedData} onFilterUpdate={this._filterUpdated}>
          <th
            key="category"
            filterkey="category"
            className="cell"
          ...
          <th filterkey="subcategory">Subcategory</th>
        </TableFilter>
      </div>
    );
  }
